...
async def analyze_resume(
    ...
    if not resume_text.strip():
        return templates.TemplateResponse("dashboard.html", {"request": request, "error": "Could not extract text.", "user": current_user})
    ...
    context = { "request": request, "user": current_user, "summary": summary, "detailed_analysis_html": detailed_analysis_html, "wellness_score_value": wellness_score_value, "wellness_score_explanation": wellness_score_explanation, "wellness_score_percent": wellness_score_percent, "ats_score": ats_score, "ats_analysis_html": ats_analysis_html, "jd_provided": jd_provided }
